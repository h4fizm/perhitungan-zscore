                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="nik" name="nik" class="form-control" type="number" placeholder="Masukkan NIK">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="alamat" name="alamat" class="form-control" type="text" placeholder="Masukkan alamat">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
