                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('simpan-pengukuran', ['id' => $id]) }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="berat_badan" name="berat_badan" class="form-control" type='number'
                                            step='0.01' value='0.00' placeholder="Masukkan Berat Badan">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="tinggi_badan" name="tinggi_badan" class="form-control" type='number'
                                            step='0.01' value='0.00' placeholder="Masukkan Tinggi Badan">
                                    </div>
                                </div>
                            </div>
                            ...
                            {{-- Button Kembali --}}
                            <a href="{{ route('list-pasien') }}" class="btn btn-secondary btn-sm"
