                                    ...
                                    @if ($pasien->isNotEmpty())
                                        @foreach ($pasien as $data)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center text-secondary font-weight-bold text-xs">{{ $data->umur }} Bulan</td>
                                                <td class="align-middle text-center text-secondary font-weight-bold text-xs">
                     ...
                     <div class="card-footer d-flex justify-content-end">
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                ...
                                @else
                                    <li class="page-item">
                                        <a class="page-link" href="{{ $pasien->previousPageUrl() }}" rel="prev">&laquo;</a>
                                    </li>
                                @endif
